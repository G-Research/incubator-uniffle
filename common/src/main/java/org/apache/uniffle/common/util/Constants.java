...
public final class Constants {
  ...
  // BlockId is long and consist of partitionId and atomicInt
  // the length of them are ATOMIC_INT_MAX_LENGTH + PARTITION_ID_MAX_LENGTH = 63
  public static final int PARTITION_ID_MAX_LENGTH = 31;
  public static final int ATOMIC_INT_MAX_LENGTH = 32;
  public static final long MAX_SEQUENCE_NO = (1L << Constants.ATOMIC_INT_MAX_LENGTH) - 1;
  public static final long MAX_PARTITION_ID = (1L << Constants.PARTITION_ID_MAX_LENGTH) - 1;
