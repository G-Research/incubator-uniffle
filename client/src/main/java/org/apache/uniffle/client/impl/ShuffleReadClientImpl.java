...
public class ShuffleReadClientImpl implements ShuffleReadClient {
  ...
  private Roaring64NavigableMap providedBlockIds = Roaring64NavigableMap.bitmapOf();
    ...
    while (true) {
      ...
      while (true) {
        ...
        if (!providedBlockIds.contains(bs.getBlockId())
          ...
          providedBlockIds.addLong(bs.getBlockId());
  ...
  @VisibleForTesting
  protected Roaring64NavigableMap getProvidedBlockIds() {
